		...
		for (RootElement rootElement : diagram.getRootElements()) {
			if (rootElement instanceof Process) {
				...
				for (FlowElement fe : process.getFlowElements()) {
					...
					// non conta gli eventi
					// if (fe instanceof Activity || fe instanceof Gateway || fe instanceof
					// SubProcess) {
					if (fe instanceof Activity || fe instanceof org.eclipse.bpmn2.Event || fe instanceof Gateway
							|| fe instanceof SubProcess) {
