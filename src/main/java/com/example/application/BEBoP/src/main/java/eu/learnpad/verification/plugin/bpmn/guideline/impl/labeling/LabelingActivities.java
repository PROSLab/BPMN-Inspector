...
public class LabelingActivities extends abstractGuideline {
	...
	Set<FlowElement> visitedElements = new HashSet<>();
	List<FlowElement> elementsBPMN = new ArrayList<>();
	List<Activity> activities = new ArrayList<>();
	StringBuilder temp = new StringBuilder();
	int num = 0;

	public void searchSubProcess(FlowElement fe) {
		if (visitedElements.contains(fe)) {
			return;
		}

		visitedElements.add(fe);
