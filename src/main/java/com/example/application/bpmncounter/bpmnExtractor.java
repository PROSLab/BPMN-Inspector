...
import com.example.application.controller.UploadController;

public class bpmnExtractor extends UploadController {


        String path = "src/main/resources/bpmnModels/bpmn_elements.csv";
