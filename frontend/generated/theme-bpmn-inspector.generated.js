...
import stylesCss from 'themes/bpmn-inspector/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_bpmn-inspector_componentCss']) {
    
    document['_vaadintheme_bpmn-inspector_componentCss'] = true;
  }
